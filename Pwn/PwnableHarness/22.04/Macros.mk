...
# Add dependency on libpwnableharness if requested
ifdef $2_USE_LIBPWNABLEHARNESS
$2_ALLLIBS := $$($2_LIBS) $$(ROOT_BUILD)/libpwnableharness.so
else
$2_ALLLIBS := $$($2_LIBS)
endif
...
$$($1+BUILD)/$2_objs/stdio_unbuffer.o: $(ROOT_DIR)/stdio_unbuffer.c
	$$(_v)$$($2_CC) $$($2_OFLAGS) $$($2_CFLAGS) -MD -MP -MF $$(@:.o=.d) -c -o $$@ $$<
...
$$(filter %.c.o,$$($2_OBJS)): $$($1+BUILD)/$2_objs/%.c.o: $1/%.c
	$$(_V)echo "Compiling $$<"
	$$(_v)$$($2_CC) $$(sort -I. -I$1) $$($2_OFLAGS) $$($2_CFLAGS) -MD -MP -MF $$(@:.o=.d) -c -o $$@ $$<

# Compiler rule for C++ sources
$$(filter %.cpp.o,$$($2_OBJS)): $$($1+BUILD)/$2_objs/%.cpp.o: $1/%.cpp
	$$(_V)echo "Compiling $$<"
	$$(_v)$$($2_CXX) $$(sort -I. -I$1) $$($2_OFLAGS) $$($2_CXXFLAGS) -MD -MP -MF $$(@:.o=.d) -c -o $$@ $$<
