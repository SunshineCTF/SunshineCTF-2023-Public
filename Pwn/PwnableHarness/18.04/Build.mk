...
PWNLIB := libpwnableharness.so
PWNABLE_SERVER := pwnableserver
PWNABLE_PRELOAD := pwnablepreload.so
TARGETS := $(PWNLIB) $(PWNABLE_SERVER) $(PWNABLE_PRELOAD)
...
$(PWNLIB)_SRCS := pwnable_harness.c
$(PWNLIB)_DEBUG := 1
...
$(PWNABLE_PRELOAD)_SRCS := stdio_unbuffer.c
